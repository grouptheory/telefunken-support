...
import telefunken.bootstrap.CrossSeedEstimator;
 ...
 * @author Bilal Khan
 */
public class CrossSeedEstimate implements IPopulationEstimator  {
    ...
    public double computeEstimate(AbstractSample S, IHasher hash) 
    {
        if (S instanceof FixedSampler.FixedSample) 
        {
            ...
            double answer;
            try {
                _calc = new CrossSeedEstimator(S, hash);
